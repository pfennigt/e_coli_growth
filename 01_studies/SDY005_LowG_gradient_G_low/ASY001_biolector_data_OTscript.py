...
if whichSteps == "medium" or whichSteps == "all":
    ...
    for curRow in [(0,3),(1,4),(2,5)]:
        curWells = plate.rows(curRow[0]) + plate.rows(curRow[1])[:-1]
        
        transfer_fillhgt((900,600),
                         M9Source,
                         curWells.top(),
                         pipette,
                         fillhgt_falcon50000,
    ...
    # Distribute M9 in last three wells of last row (blank) as small gradient
    curWells = plate.cols(7)[3:6]
    
    transfer_fillhgt((1000,700),
                     M9Source,
                     curWells.top(),
                     pipette,
                     fillhgt_falcon50000,
    ...
    # Distribute glucose everywhere but in blanks
    for curRow in [(0,3),(1,4),(2,5)]:
        curWells = plate.rows(curRow[0]) + plate.rows(curRow[1])[:-1]
        
        transfer_fillhgt((0,300),
                         GlcSource,
                         curWells.top(),
                         pipette,
                         fillhgt_falcon50000,
    ...
    # Distribute glucose in last three wells with complementatry small gradient
    curWells = plate.cols(7)[3:6]
